...
export const commonAr: CommonContent = {
  ...
  form: {
    ...
    consultationNote:
      'نحتاج إلى مهلة يومين على الأقل لمراجعة تفاصيل مشروعك، لذلك لا تتوفر مكالمات في نفس اليوم. اختر التاريخ والفترة المناسبة وسنؤكد الموعد عبر البريد الإلكتروني.',
