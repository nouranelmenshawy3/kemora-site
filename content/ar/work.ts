...
const arabicCopy: Record<string, Pick<WorkItem, 'title' | 'note' | 'alt'>> = {
  ...
  'white-lounge-set': {
    title: 'طقم قميص وبنطلون مقلم',
    note: 'محجوب عن المعرض العام لحين الحصول على إذن النشر.',
    alt: 'عارضة ترتدي قميصًا واسعًا مقلمًا مع بنطلون مطابق',
  },
  'checked-colorways': {
    title: 'ألوان مختلفة لقميص مقلم',
    note: 'محجوب عن المعرض العام لحين الحصول على إذن النشر.',
    alt: 'لونان مختلفان لطقم قميص وبنطلون مقلم معروضان جنبًا إلى جنب',
  },
}
